    ...
    >
      ...
      {(pm.quantity > 1 || onUpdateQuantity) && (
        <button
          ...
          className={`absolute -top-1.5 -right-1.5 z-10 text-[10px] text-white font-bold bg-white/30 backdrop-blur-sm px-1.5 py-0.5 rounded-full flex items-center gap-0.5 shrink-0 shadow-md border border-white/20 ${onUpdateQuantity ? 'hover:bg-white/40 cursor-pointer' : ''}`}
        >

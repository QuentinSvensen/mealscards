    ...
    >
      ...
      <div className="flex items-center gap-1.5">
        ...
        {meal.grams && (
          <button
            onClick={() => {
              setEditValue(meal.grams || "");
              setEditing("grams");
            }}
            className="text-[10px] text-white/70 bg-white/20 px-1 py-0.5 rounded-full flex items-center gap-0.5 hover:bg-white/30 shrink-0"
          >
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem
              onClick={() => {
                setEditValue(meal.ingredients || "");
                setEditing("ingredients");
              }}
            >
      ...
      {editing === "ingredients" ? (
        ...
        <Input
          autoFocus
          placeholder={editing === "calories" ? "Ex: 350 kcal" : "Ex: 150g"}
          value={editValue}
          onChange={(e) => setEditValue(e.target.value)}
          onBlur={handleSaveEdit}
      ...
      <div className="flex items-center gap-1 mt-1.5 flex-wrap">
        ...
        <Select
          value={pm.meal_time || "none"}
          onValueChange={(val) => onUpdatePlanning(pm.day_of_week, val === "none" ? null : val)}
        >
